...
double Ionization::ionizedFraction(double nH, double T, const vector<double>& wavelength, const vector<double>& isrf)
{
    ...
    double C = NumUtils::integrate<double>(wavelength, integrand) / Constant::PLANCK / recombinationRate(T);

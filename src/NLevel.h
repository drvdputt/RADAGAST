...
public:
	...
	void solveBalance(double atomDensity, double electronDensity, double protonDensity, double T,
...
private:
	...
	void solveRateEquations(Eigen::VectorXd sourceTerm, Eigen::VectorXd sinkTerm, size_t chooseConsvEq);

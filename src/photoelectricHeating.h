...
double heatingRate(std::vector<double>& wavelength, std::vector<double>& Qabs, std::vector<double>& isrf);

double emissionRate(double a, int Z, std::vector<double>& wavelength, std::vector<double>& Qabs, std::vector<double>& isrf);
...
void chargeBalance(double a, std::vector<double>& wavelength, std::vector<double>& Qabs, std::vector<double>& isrf,

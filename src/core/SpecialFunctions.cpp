...
namespace GasModule
{
    ...
    double SpecialFunctions::pseudoVoigt(double x, double sigma_gauss, double gamma_lorentz)
    {
        ...
        double Gamma =
            std::pow(GammaGN[4] + 2.69269 * GammaGN[3] * GammaLN[0] + 2.42843 * GammaGN[2] * GammaLN[1]
                         + 4.47163 * GammaGN[1] * GammaLN[2] + 0.07842 * GammaGN[0] * GammaLN[3] + GammaLN[4],
                     0.2);

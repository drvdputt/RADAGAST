...
namespace GasModule
{
    ...
    {
        // Table 1. Fitting coefficients for the cooling rate of ortho-H2 excited by collisions
        ...
        // Table 3. Fitting coefficients for the cooling rate of para-H2 excited by collisions with
        // H2.
        ...
        // Table 4. Fitting coefficients for the cooling rate of ortho-H2 excited by collisions
        // with H2.
        ...
        // Table 6. Fitting coefficients for the cooling rate of H2 excited by collisions with
        // protons.
        ...
        /** Cooling rate due to H2 (either ortho or para) excited by collisions with H2 (either
            ortho or para). The second argument should be one of the four H2 collision coefficient
            sets. */
        ...
        /** Cooling rate due to H2 (either ortho or para) excited by collisions with protons. The
            second argument should be one of the two p+ collision coefficient sets. */
        double coolProtonPolynomial(double T, const std::vector<double>& coefficients);

        /** Cooling rate due to ortho-para conversions induced by p+ collisions. Should only matter
            when out of thermodynamic equilibrium. [erg cm3 s-1] */

...
namespace GasModule
{
    ...
    public:
        ...
        GasState(const std::valarray<double>& emissivityv, const std::valarray<double>& opacityv, double T,
                 std::valarray<double>& densityv)
            : _emissivityv(emissivityv), _opacityv(opacityv), _temperature(T), _densityv(densityv)
        {}

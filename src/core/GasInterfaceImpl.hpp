...
/** This class is the backbone of the whole code. It calculates the abundances, level populations
    and net heating rate of hydrogen repeatedly, until the equilibrium temperature is found. A
    public front-end to this class exists (\c GasInterface). The documentation for functions not
    documented here can be found there.

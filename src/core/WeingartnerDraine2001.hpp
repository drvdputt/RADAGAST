...
namespace GasModule
{
    ...
    namespace WD01
    {
        ...
        /** The sticking coefficient based on equations 1 and 27-30. z_i is the charge of the
            particle colliding with the grain. */
        ///@{
        double estick_positive(double a);
        double estick_negative(double a);
        double stickingCoefficient_cached(double a, int z, int z_i, bool carbonaceous, double estick_cached_positive,

...
double GloverAbel08::coolParaPara(double T)
{
    return coolH2H2Polynomial(T, para_para_av);
}

double GloverAbel08::coolParaOrtho(double T)
{
    return coolH2H2Polynomial(T, para_ortho_av);
}

double GloverAbel08::coolOrthoPara(double T)
{
    return coolH2H2Polynomial(T, ortho_para_av);
}

double GloverAbel08::coolOrthoOrtho(double T)
{
    return coolH2H2Polynomial(T, ortho_ortho_av);
}
...
double GloverAbel08::coolParaProton(double T)
{
    return coolProtonPolynomial(T, para_p_av);
}

double GloverAbel08::coolOrthoProton(double T)
{
    return coolProtonPolynomial(T, ortho_p_av);
}

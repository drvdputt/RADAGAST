...
namespace GasModule
{
    ...
    {
    public:
        /** Constructs an object which will contain the data to simulate a toy model of CII 158 um.
            The data comes from https://www.astro.umd.edu/~jph/N-level.pdf, bottom of page 4. */
        TwoLevelHardcoded();

...
Array TwoPhoton::emissivityv(const Array& eFrequencyv, double n2s)
{
    ...
    // Energy difference between 2s and 1s. We could use an HData object for this, but hardcoding
    // is a fine enough solution. The number comes from h_1.elvlc in the CHIANTI data for H, and
    // are in cm-1.
